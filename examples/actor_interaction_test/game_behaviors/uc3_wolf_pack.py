...
def apply_feeding(accessor, item, actor) -> Optional[str]:
    ...
    """
    from game_behaviors.actor_lib.packs import sync_pack_disposition, is_alpha
    from game_behaviors.actor_lib.relationships import modify_relationship
...
def directed_flee(accessor, actor) -> Optional[str]:
    ...
    """
    from game_behaviors.actor_lib.morale import check_flee_condition
    ...
    from game_behaviors.actor_lib.morale import attempt_flee
...
def check_domestication(actor, target_id: str = "player") -> bool:
    ...
    """
    from game_behaviors.actor_lib.relationships import check_threshold

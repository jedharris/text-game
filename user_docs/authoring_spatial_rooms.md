# Authoring Spatial Rooms

This guide shows you how to design and implement spatial awareness in your text adventure games using the Part entity system.

---

## Table of Contents

1. [When to Use Spatial Structure](#when-to-use-spatial-structure)
2. [Quick Start Guide](#quick-start-guide)
3. [Understanding Parts](#understanding-parts)
4. [Common Patterns](#common-patterns)
5. [Positioning and Movement](#positioning-and-movement)
6. [Advanced Techniques](#advanced-techniques)
7. [Troubleshooting](#troubleshooting)

---

## When to Use Spatial Structure
...
For more details, see the [Spatial Structure Design Document](../docs/spatial_structure.md).

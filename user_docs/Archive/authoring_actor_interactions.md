...
This chapter covers how to create interactions between actors: combat, healing, services, environmental effects, and more. It builds on the fundamentals from [Authoring Actors](authoring_actors.md).
...
Parts are sub-areas within a location (see [Spatial System](authoring_manual.md#spatial-system) for full details). They have properties that can affect actors.
...
See [Authoring Actors](authoring_actors.md) for the foundational actor properties this chapter builds upon.

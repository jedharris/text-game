# Authoring Actors - Fundamentals

> **Part of the Authoring Manual series** - See [Section 4 of the Authoring Manual](authoring_manual.md#4-actors-and-interactions) for an overview.
...
**Prerequisites**: This chapter assumes familiarity with the basic concepts in the [Authoring Manual](authoring_manual.md), particularly entity structure, properties, and behaviors.

**Companion chapter**: [Authoring Actor Interactions](authoring_actor_interactions.md) covers how to create specific interactions like combat, healing, services, and environmental effects.
...
Breath decreases in non-breathable areas (see [Environmental Effects](authoring_actor_interactions.md#environmental-effects)).
...
See [Combat](authoring_actor_interactions.md#combat) for how attacks are selected and executed.
...
When a need is satisfied (e.g., by feeding), the actor's disposition can change. See [Domestication](authoring_actor_interactions.md#domestication) for how feeding wolves creates friendship.
...
See [Services Framework](authoring_actor_interactions.md#services-framework) for details.
...
Now that you understand actor fundamentals, see [Authoring Actor Interactions](authoring_actor_interactions.md) to learn how to:

- Create combat encounters with attacks, damage, and cover
- Set up conditions that affect actors
- Configure NPC services and trading
- Build progressive relationships and domestication

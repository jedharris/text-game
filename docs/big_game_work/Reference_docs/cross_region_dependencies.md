...
World state changes are **instant, universally perceived events** - fundamental shifts in the world that all beings sense directly, like the lifting of a curse. Unlike gossip (which travels between NPCs over time) or environmental spread (which progresses gradually), these are binary flips that immediately affect the entire world.

### Waystone Repair

**Trigger**: All 5 waystone fragments placed in Nexus Chamber

**Global Flag**: `waystone_complete = true`

**Immediate Effects**:
- Fast travel unlocked between all regions
- Echo transforms (ceremony in Nexus)
- Environmental spreads halt (spore and cold)
- Meridian Blessing buff applied to player
- NPCs throughout world sense "something has changed" - ley lines restored

**NPC Reactions**: NPCs don't need to "hear about" the waystone repair. They *feel* the shift in the world's magical fabric. Dialog can reference "The air feels cleaner" or "The old magic stirs again."

### Telescope Repair

**Trigger**: Observatory telescope functional (all components gathered and applied)

**Global Flag**: `observatory_functional = true`

**Immediate Effects**:
- Cold spread prevention activated
- Crystal garden advances (+1)
- Strategic information available to player (can see NPC states in other regions)
- Frozen Reaches stabilizes

**NPC Reactions**: Characters sensitive to the cold (salamanders, humans near borders) notice the shift. "The bitter winds have softened."

### Implementation Note

These events are handled via global flags, not gossip:
- Set flag immediately when trigger condition met
- NPCs check flag in dialog/behavior conditions
- No delivery timing, no gossip queue
- Narration can describe the moment of change dramatically
...
**Implementation Note**: Gossip storage and delivery is handled by infrastructure utilities. Broadcast gossip events (Spore Mother healed, major reputation changes) are stored centrally and delivered to all regions at the specified timing. Individual region designs do not need to document receiving broadcast events - infrastructure handles this automatically. Region designs only document gossip they ORIGINATE and specific NPC reactions to received gossip.
...
|-------------|--------|-------------|--------|-------|
| Sira's fate | Beast Wilds | Elara (Civilized) | 12 turns | Travelers mention injured hunter. If Sira dies, news reaches Elara. |
| Sira abandonment | Beast Wilds | Elara (Civilized) | 20 turns | Only spreads if Sira survives AND tells others. Or through Echo influence. |
| Aldric's fate | Fungal Depths | Civilized Remnants | 25 turns | Scholar's fate becomes known over time |
| Delvan's fate | Sunken District | Undercity | 7 turns | Fast - criminal networks communicate quickly |
| Assassination | Civilized Remnants | Echo | 0 turns | Echo always knows immediately |
| Assassination | Civilized Remnants | Other councilors | 0-5 turns | Depends on discovery roll (20%) |
| Spore Mother healed | Fungal Depths | All regions | 15 turns | Major event, spreads relatively fast |
| Spore Mother killed | Fungal Depths | All fungal creatures, Echo | 1 turn | Spore network + Echo ley lines |
| Bear cubs fate | Beast Wilds | Sira (if alive) | 8 turns | Sira notices nearby |
| Garrett fate | Sunken District | Camp NPCs | 0 turns | Immediate - same location |
...
|----------|--------|---------|
| Player confesses before gossip arrives | Before turn 20 (from abandonment) | Confession mechanic: -2 trust, recovery possible |
| Gossip arrives before player visits Elara | Turn 20+ after abandonment | Discovery mechanic: -3 trust, permanent consequences |

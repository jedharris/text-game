...
class TestUC7SpiderPack(BaseTestCase):
...
class TestUC7VenomAttack(BaseTestCase):
...
class TestUC7WebBurning(BaseTestCase):
...
class TestUC7AlertPropagation(BaseTestCase):

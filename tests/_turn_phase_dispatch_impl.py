"""Implementation of turn phase dispatch tests.

DO NOT import this module directly - it will cause module pollution.
Run via test_turn_phase_dispatch.py wrapper instead.
...
# Path setup
BIG_GAME_DIR = (Path(__file__).parent.parent / 'examples' / 'big_game').resolve()

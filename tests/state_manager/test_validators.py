...
class TestValidators(unittest.TestCase):
    ...
    def test_TV007_item_location_consistency(self):
        ...
        # Fixture has location.items claiming item_1, but item_1.location points to loc_2
        with self.assertRaises(ValidationError) as ctx:
            load_game_state(get_fixture_path("item_location_mismatch.json"))

        assert_validation_error_contains(ctx.exception, "item_1")

...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_TE001_multiple_errors_aggregated(self):
        ...
        #     self.assertIn("3", error_str)  # Error count
        pass
    ...
    def test_TE005_warnings_do_not_abort_parsing(self):
        ...
        # import logging
        #
        # # Create data with orphaned items (warning, not error)
        # data = {
        #     "metadata": {
        #         "title": "Test",
        #         "version": "1.0",
        ...
        #             "id": "item_1",
        #             "name": "Orphaned Item",
        #             "description": "Not in any location list",
        #             "type": "tool",
        #             "portable": True,
        #             "location": "loc_1"
        #         }
        ...
        # }
        #
        # # Should parse successfully despite warning
        # with self.assertLogs(level=logging.WARNING) as logs:
        #     game_state = parse_game_state(data)
        #     self.assertIsNotNone(game_state)
        #
        #     # Check warning was logged
        #     self.assertTrue(any("orphaned" in log.lower() for log in logs.output))
        pass

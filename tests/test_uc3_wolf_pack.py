...
class TestUC3PackSync(BaseTestCase):
...
class TestUC3Feeding(BaseTestCase):
...
class TestUC3MoraleFlee(BaseTestCase):
...
class TestUC3Relationship(BaseTestCase):
...
class TestUC3Domestication(BaseTestCase):

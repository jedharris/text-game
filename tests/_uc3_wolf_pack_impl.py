...
class TestUC3PackSync(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.alpha = self.engine.game_state.actors['npc_alpha_wolf']
        self.wolf1 = self.engine.game_state.actors['npc_wolf_1']
        self.wolf2 = self.engine.game_state.actors['npc_wolf_2']

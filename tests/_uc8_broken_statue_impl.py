...
class TestUC8Repair(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.statue = self.engine.game_state.actors['npc_broken_statue']
        self.chisel = None
...
class TestUC8Functional(unittest.TestCase):
...
class TestUC8GuardDuty(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.hostile = self.engine.game_state.actors.get('npc_spider_queen')

...
class TestBigGameConditionIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.engine = GameEngine('examples/big_game')
...
class TestRegionalBehaviorConditions(unittest.TestCase):
    ...
    def test_fungal_infection_uses_dict_format(self):
        ...
        from examples.big_game.behaviors.regions.fungal_depths import spore_zones
    ...
    def test_hypothermia_uses_dict_format(self):
        ...
        from examples.big_game.behaviors.regions.frozen_reaches import hypothermia

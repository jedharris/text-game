...
class TestUC5Breath(BaseTestCase):
...
class TestUC5Drowning(BaseTestCase):
...
class TestUC5BreathingItem(BaseTestCase):
...
class TestUC5Rescue(BaseTestCase):
...
class TestUC5ConstructImmune(BaseTestCase):
